...
export default function Header({searchHandler, label, labelHandler}) {
    ...
    return (
        <Box color='primary.contrastText' component="header" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 2, border: '1px dashed grey', bgcolor: 'primary.main', marginTop: '20px', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px'}}>
